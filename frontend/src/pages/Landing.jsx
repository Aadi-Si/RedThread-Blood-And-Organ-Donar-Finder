...
//   const testimonials = [
//     { quote: "RedThread notified me within seconds. I was at the hospital in 20 minutes. The patient survived.", name: "Arjun Mehta", role: "Blood Donor, Delhi", avatar: "AM", delay: 0 },
//     { quote: "We posted a critical O- request at 2am. Three donors responded within minutes. This platform is incredible.", name: "Dr. Priya Sharma", role: "Chief Surgeon, Apollo Hospital", avatar: "PS", delay: 150 },
//     { quote: "My daughter needed a rare blood type. RedThread found a matching donor 4km away in under 5 minutes.", name: "Sunita Kapoor", role: "Patient's Mother, Mumbai", avatar: "SK", delay: 300 },
//   ]
...
//         .preloader { position:fixed;inset:0;z-index:9999;background:#B91C1C;display:flex;align-items:center;justify-content:center;transition:opacity 0.8s ease,visibility 0.8s ease; }
//         .preloader.hide { opacity:0;visibility:hidden;pointer-events:none; }
//         .preloader-text { font-size:32px;font-weight:800;color:white;letter-spacing:-1px;animation:preloaderPulse 0.8s ease infinite alternate; }
//         @keyframes preloaderPulse { from{opacity:0.6;transform:scale(0.98)} to{opacity:1;transform:scale(1)} }

//         .cursor-glow { position:fixed;width:500px;height:500px;border-radius:50%;background:radial-gradient(circle,rgba(185,28,28,0.06) 0%,transparent 70%);pointer-events:none;z-index:0;transition:left 0.15s ease,top 0.15s ease; }

//         .nav { position:fixed;top:0;left:0;right:0;z-index:100;padding:0 64px;height:72px;display:flex;justify-content:space-between;align-items:center;transition:all 0.3s ease; }
//         .nav.scrolled { background:rgba(255,255,255,0.92);backdrop-filter:blur(20px);box-shadow:0 1px 40px rgba(0,0,0,0.08); }
//         .nav-logo { font-size:20px;font-weight:800;color:#B91C1C;letter-spacing:-0.5px;cursor:pointer; }
//         .nav-links { display:flex;gap:40px;align-items:center; }
//         .nav-link { font-size:14px;font-weight:500;color:#555;cursor:pointer;transition:color 0.2s;text-decoration:none; }
//         .nav-link:hover { color:#B91C1C; }
//         .nav-btns { display:flex;gap:12px;align-items:center; }
//         .btn-outline { background:transparent;border:1.5px solid #B91C1C;color:#B91C1C;padding:10px 24px;border-radius:100px;font-size:14px;font-weight:600;cursor:pointer;font-family:inherit;transition:all 0.2s; }
//         .btn-outline:hover { background:#B91C1C;color:white;transform:translateY(-1px); }
//         .btn-solid { background:#B91C1C;border:none;color:white;padding:10px 24px;border-radius:100px;font-size:14px;font-weight:600;cursor:pointer;font-family:inherit;transition:all 0.2s;box-shadow:0 4px 20px rgba(185,28,28,0.35); }
//         .btn-solid:hover { background:#991B1B;transform:translateY(-1px);box-shadow:0 8px 30px rgba(185,28,28,0.45); }

//         .hero { min-height:100vh;display:flex;align-items:center;padding:120px 64px 80px;background:linear-gradient(135deg,#fff 0%,#fff5f5 50%,#fff 100%);position:relative;overflow:hidden; }
//         .hero-bg-circle-1 { position:absolute;width:800px;height:800px;border-radius:50%;background:radial-gradient(circle,rgba(185,28,28,0.06) 0%,transparent 70%);right:-200px;top:-200px;pointer-events:none; }
//         .hero-bg-circle-2 { position:absolute;width:400px;height:400px;border-radius:50%;background:radial-gradient(circle,rgba(185,28,28,0.04) 0%,transparent 70%);left:-100px;bottom:-100px;pointer-events:none; }
//         .hero-threads { position:absolute;inset:0;pointer-events:none;overflow:hidden; }
//         .hero-content { position:relative;z-index:1;max-width:680px; }
//         .hero-badge { display:inline-flex;align-items:center;gap:8px;background:rgba(185,28,28,0.08);border:1px solid rgba(185,28,28,0.2);color:#B91C1C;padding:8px 18px;border-radius:100px;font-size:13px;font-weight:600;margin-bottom:28px;opacity:0;transform:translateY(20px);animation:fadeUp 0.7s ease 0.3s forwards; }
//         .heartbeat { animation:heartbeat 1.2s ease infinite;display:inline-block; }
//         @keyframes heartbeat { 0%,100%{transform:scale(1)} 14%{transform:scale(1.2)} 28%{transform:scale(1)} 42%{transform:scale(1.15)} 70%{transform:scale(1)} }
//         .hero-title { font-size:clamp(48px,6vw,80px);font-weight:900;line-height:1.05;letter-spacing:-2.5px;margin-bottom:24px;opacity:0;transform:translateY(20px);animation:fadeUp 0.7s ease 0.5s forwards; }
//         .hero-title .gradient-text { background:linear-gradient(135deg,#B91C1C 0%,#ef4444 50%,#f87171 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text; }
//         .hero-sub { font-size:18px;color:#666;line-height:1.7;max-width:520px;margin-bottom:40px;font-weight:400;opacity:0;transform:translateY(20px);animation:fadeUp 0.7s ease 0.7s forwards; }
//         .hero-btns { display:flex;gap:16px;flex-wrap:wrap;opacity:0;transform:translateY(20px);animation:fadeUp 0.7s ease 0.9s forwards; }
//         .btn-hero-primary { background:#B91C1C;color:white;border:none;padding:16px 40px;border-radius:100px;font-size:16px;font-weight:700;cursor:pointer;font-family:inherit;transition:all 0.3s;box-shadow:0 8px 30px rgba(185,28,28,0.35);display:flex;align-items:center;gap:8px; }
//         .btn-hero-primary:hover { background:#991B1B;transform:translateY(-3px);box-shadow:0 16px 40px rgba(185,28,28,0.45); }
//         .btn-hero-secondary { background:white;color:#B91C1C;border:2px solid rgba(185,28,28,0.2);padding:16px 40px;border-radius:100px;font-size:16px;font-weight:600;cursor:pointer;font-family:inherit;transition:all 0.3s; }
//         .btn-hero-secondary:hover { border-color:#B91C1C;transform:translateY(-3px);box-shadow:0 8px 20px rgba(185,28,28,0.15); }
//         .hero-visual { position:absolute;right:64px;top:50%;transform:translateY(-50%);width:500px;height:500px;opacity:0;animation:fadeIn 1s ease 1s forwards; }
//         .hero-card { background:white;border-radius:20px;padding:24px;box-shadow:0 20px 60px rgba(0,0,0,0.1);position:absolute; }
//         .hero-card-main { width:300px;top:50%;left:50%;transform:translate(-50%,-50%); }
//         .hero-card-notify { width:220px;top:10%;right:0;animation:float 4s ease infinite; }
//         .hero-card-donor { width:200px;bottom:10%;left:0;animation:float 4s ease 2s infinite; }
//         @keyframes float { 0%,100%{transform:translateY(0)} 50%{transform:translateY(-12px)} }
//         .card-label { font-size:11px;font-weight:700;color:#999;letter-spacing:1px;text-transform:uppercase;margin-bottom:12px; }
//         .blood-type { font-size:48px;font-weight:900;color:#B91C1C;letter-spacing:-2px;line-height:1; }
//         .card-sub { font-size:13px;color:#666;margin-top:8px; }
//         .notify-icon { font-size:28px;margin-bottom:8px; }
//         .notify-title { font-size:14px;font-weight:700;color:#111; }
//         .notify-sub { font-size:12px;color:#666;margin-top:4px; }
//         .notify-time { font-size:11px;color:#B91C1C;font-weight:600;margin-top:8px; }
//         .donor-name { font-size:15px;font-weight:700;color:#111; }
//         .donor-info { font-size:12px;color:#666;margin-top:4px; }
//         .donor-badge { display:inline-block;background:#dcfce7;color:#16a34a;font-size:11px;font-weight:700;padding:3px 10px;border-radius:100px;margin-top:8px; }
//         .ring { position:absolute;border-radius:50%;border:1px solid rgba(185,28,28,0.15);top:50%;left:50%;transform:translate(-50%,-50%);animation:ringPulse 3s ease infinite; }
//         @keyframes ringPulse { 0%{opacity:0.8;transform:translate(-50%,-50%) scale(0.8)} 100%{opacity:0;transform:translate(-50%,-50%) scale(1.5)} }

//         /* Stats */
//         .stats-section { padding:80px 64px;background:white;border-top:1px solid #f0f0f0;border-bottom:1px solid #f0f0f0; }
//         .stats-grid { display:grid;grid-template-columns:repeat(4,1fr);gap:0;max-width:1100px;margin:0 auto; }
//         .stat-item { padding:24px 40px;text-align:center;border-right:1px solid #f0f0f0; }
//         .stat-item:last-child { border-right:none; }
//         .stat-num { font-size:52px;font-weight:900;letter-spacing:-2px;line-height:1;background:linear-gradient(135deg,#B91C1C,#ef4444);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text; }
//         .stat-label { font-size:14px;color:#888;font-weight:500;margin-top:8px; }
...
//         /* Section commons */
//         .section { padding:120px 64px;max-width:1200px;margin:0 auto; }
//         .section-tag { font-size:12px;font-weight:700;color:#B91C1C;letter-spacing:3px;text-transform:uppercase;margin-bottom:16px; }
//         .section-title { font-size:clamp(32px,4vw,52px);font-weight:800;letter-spacing:-1.5px;line-height:1.1;margin-bottom:16px; }
//         .section-sub { font-size:16px;color:#666;max-width:480px;line-height:1.7; }

//         /* Features */
//         .features-bg { background:#fafafa; }
//         .features-grid { display:grid;grid-template-columns:repeat(3,1fr);gap:20px;margin-top:64px; }
//         .feature-card { border-radius:20px;padding:36px;border:1.5px solid transparent;transition:all 0.4s cubic-bezier(0.34,1.56,0.64,1);cursor:default;opacity:0;transform:translateY(30px); }
//         .feature-card.visible { opacity:1;transform:translateY(0); }
//         .feature-card:hover { transform:translateY(-8px) scale(1.02);box-shadow:0 24px 60px rgba(185,28,28,0.12); }
//         .feature-icon { font-size:40px;margin-bottom:20px;display:block;transition:transform 0.3s; }
//         .feature-card:hover .feature-icon { transform:scale(1.2) rotate(-5deg); }
//         .feature-title { font-size:18px;font-weight:700;margin-bottom:10px;letter-spacing:-0.3px; }
//         .feature-desc { font-size:14px;color:#666;line-height:1.7; }

//         /* Steps */
//         .steps-bg { background:white; }
//         .steps-wrapper { display:grid;grid-template-columns:1fr 1fr;gap:80px;align-items:center;margin-top:64px; }
//         .steps-list { display:flex;flex-direction:column;gap:0; }
//         .step-item { display:flex;gap:20px;padding:24px;border-radius:16px;cursor:pointer;transition:all 0.3s;border:2px solid transparent;position:relative; }
//         .step-item.active { background:#fff5f5;border-color:#fecaca; }
//         .step-circle { width:56px;height:56px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:20px;font-weight:900;color:white;flex-shrink:0;transition:all 0.3s; }
//         .step-content { flex:1; }
//         .step-num-label { font-size:11px;font-weight:700;color:#B91C1C;letter-spacing:2px;text-transform:uppercase;margin-bottom:4px; }
//         .step-title { font-size:18px;font-weight:700;margin-bottom:6px; }
//         .step-desc { font-size:14px;color:#666;line-height:1.6; }
//         .steps-visual { position:relative;height:400px; }
//         .step-phone { width:240px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);background:white;border-radius:32px;box-shadow:0 32px 80px rgba(0,0,0,0.15);overflow:hidden;border:8px solid #111;transition:all 0.5s; }
//         .phone-screen { background:linear-gradient(135deg,#fff5f5,#fff);padding:20px;min-height:380px; }
//         .phone-header { display:flex;justify-content:space-between;align-items:center;margin-bottom:20px; }
//         .phone-logo { font-size:14px;font-weight:800;color:#B91C1C; }
//         .phone-status { font-size:11px;color:#16a34a;font-weight:600;background:#dcfce7;padding:3px 8px;border-radius:100px; }
//         .phone-card { background:white;border-radius:16px;padding:16px;box-shadow:0 4px 20px rgba(0,0,0,0.08);margin-bottom:12px; }
//         .phone-blood { font-size:32px;font-weight:900;color:#B91C1C;letter-spacing:-2px; }
//         .phone-detail { font-size:12px;color:#666;margin-top:4px; }
//         .phone-alert { background:#fef2f2;border:1px solid #fecaca;border-radius:10px;padding:10px;font-size:12px;color:#B91C1C;font-weight:600;margin-top:8px; }
//         .phone-btn { background:#B91C1C;color:white;border:none;width:100%;padding:12px;border-radius:12px;font-size:14px;font-weight:700;cursor:pointer;margin-top:12px;font-family:inherit; }

//         /* Impact */
//         .impact-bg { background:linear-gradient(135deg,#7F1D1D 0%,#B91C1C 50%,#DC2626 100%);position:relative;overflow:hidden; }
//         .impact-bg-pattern { position:absolute;inset:0;background-image:radial-gradient(circle,rgba(255,255,255,0.05) 1px,transparent 1px);background-size:30px 30px;pointer-events:none; }
//         .impact-inner { padding:120px 64px;max-width:1200px;margin:0 auto;position:relative; }
//         .impact-title { font-size:clamp(36px,5vw,64px);font-weight:900;color:white;letter-spacing:-2px;margin-bottom:20px; }
//         .impact-sub { font-size:18px;color:rgba(255,255,255,0.7);max-width:520px;line-height:1.7;margin-bottom:64px; }
//         .testimonials-grid { display:grid;grid-template-columns:repeat(3,1fr);gap:24px; }
//         .testimonial-card { background:rgba(255,255,255,0.1);backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,0.15);border-radius:20px;padding:32px;transition:all 0.4s;opacity:0;transform:translateY(30px); }
//         .testimonial-card.visible { opacity:1;transform:translateY(0); }
//         .testimonial-card:hover { background:rgba(255,255,255,0.18);transform:translateY(-6px);box-shadow:0 20px 60px rgba(0,0,0,0.2); }
//         .quote-mark { font-size:48px;color:rgba(255,255,255,0.3);line-height:1;margin-bottom:16px;font-family:Georgia,serif; }
//         .quote-text { font-size:15px;color:rgba(255,255,255,0.9);line-height:1.7;margin-bottom:24px;font-style:italic; }
//         .quote-avatar { width:40px;height:40px;border-radius:50%;background:rgba(255,255,255,0.2);display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:800;color:white;margin-bottom:10px; }
//         .quote-name { font-size:14px;font-weight:700;color:white; }
//         .quote-role { font-size:12px;color:rgba(255,255,255,0.6);margin-top:4px; }

//         /* Map */
//         .map-section { background:#fafafa;padding:120px 64px; }
//         .map-inner { max-width:1200px;margin:0 auto; }
//         .map-container { margin-top:64px;background:white;border-radius:24px;border:1px solid #f0f0f0;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,0.06);height:480px;position:relative; }
//         .map-bg-grad { position:absolute;inset:0;background:linear-gradient(135deg,#f8fafc 0%,#fff5f5 50%,#f8fafc 100%); }
//         .map-grid { position:absolute;inset:0;background-image:linear-gradient(rgba(185,28,28,0.04) 1px,transparent 1px),linear-gradient(90deg,rgba(185,28,28,0.04) 1px,transparent 1px);background-size:40px 40px; }
...
//         .map-dot.active { background:#B91C1C; }
//         .map-dot.inactive { background:#d1d5db; }
//         .map-dot.lg { width:18px;height:18px; }
//         .map-dot.md { width:13px;height:13px; }
//         .map-dot.sm { width:9px;height:9px; }
//         .map-dot.active.lg { box-shadow:0 0 0 6px rgba(185,28,28,0.15);animation:mapPulse 2s ease infinite; }
//         .map-dot.active.md { box-shadow:0 0 0 4px rgba(185,28,28,0.12);animation:mapPulse 2s ease 0.5s infinite; }
//         .map-dot.highlighted { transform:translate(-50%,-50%) scale(1.5);box-shadow:0 0 0 8px rgba(185,28,28,0.25) !important; }
//         @keyframes mapPulse { 0%,100%{box-shadow:0 0 0 4px rgba(185,28,28,0.15)} 50%{box-shadow:0 0 0 12px rgba(185,28,28,0.05)} }
//         .map-tooltip { position:absolute;background:white;border-radius:12px;padding:12px 16px;box-shadow:0 8px 32px rgba(0,0,0,0.15);font-size:13px;pointer-events:none;z-index:10;white-space:nowrap;transform:translate(-50%,-130%);transition:all 0.2s; }
//         .map-tooltip::after { content:'';position:absolute;bottom:-6px;left:50%;transform:translateX(-50%);width:12px;height:12px;background:white;clip-path:polygon(0 0,100% 0,50% 100%); }
//         .tooltip-name { font-weight:700;color:#111; }
//         .tooltip-blood { font-size:12px;color:#B91C1C;font-weight:600;margin-top:2px; }
//         .map-title { position:absolute;top:24px;left:24px;background:white;border-radius:12px;padding:12px 20px;box-shadow:0 4px 20px rgba(0,0,0,0.1);font-size:14px;font-weight:700;color:#111; }
//         .map-count { position:absolute;top:24px;right:24px;background:#B91C1C;border-radius:12px;padding:10px 16px;font-size:13px;font-weight:700;color:white;animation:countPulse 2s ease infinite; }
//         @keyframes countPulse { 0%,100%{box-shadow:0 0 0 0 rgba(185,28,28,0.4)} 50%{box-shadow:0 0 0 8px rgba(185,28,28,0)} }
//         .map-legend { position:absolute;bottom:24px;right:24px;background:white;border-radius:12px;padding:16px 20px;box-shadow:0 4px 20px rgba(0,0,0,0.1);font-size:13px; }
//         .legend-item { display:flex;align-items:center;gap:8px;margin-bottom:8px;color:#555; }
//         .legend-item:last-child { margin-bottom:0; }
//         .legend-dot { width:10px;height:10px;border-radius:50%;flex-shrink:0; }
//         .map-request { position:absolute;bottom:24px;left:24px;background:white;border-radius:12px;padding:14px 18px;box-shadow:0 4px 20px rgba(0,0,0,0.1);font-size:13px;max-width:220px; }
//         .map-req-title { font-weight:700;color:#111;margin-bottom:4px;font-size:14px; }
//         .map-req-detail { font-size:12px;color:#666; }
//         .map-req-badge { display:inline-block;background:#fef2f2;color:#B91C1C;font-size:11px;font-weight:700;padding:3px 8px;border-radius:100px;margin-top:6px; }
//         .map-connection { position:absolute;pointer-events:none;z-index:1; }

//         /* CTA */
//         .cta-section { padding:140px 64px;text-align:center;background:white;position:relative;overflow:hidden; }
//         .cta-bg { position:absolute;inset:0;background:radial-gradient(ellipse at center,rgba(185,28,28,0.05) 0%,transparent 70%); }
//         .cta-title { font-size:clamp(40px,6vw,72px);font-weight:900;letter-spacing:-2px;margin-bottom:20px;position:relative;line-height:1.05; }
//         .cta-sub { font-size:18px;color:#666;max-width:480px;margin:0 auto 48px;line-height:1.7;position:relative; }
//         .cta-btns { display:flex;gap:16px;justify-content:center;flex-wrap:wrap;position:relative; }
//         .cta-trust { display:flex;align-items:center;justify-content:center;gap:32px;margin-top:48px;position:relative; }
//         .trust-item { display:flex;align-items:center;gap:8px;font-size:14px;color:#888;font-weight:500; }

//         /* Footer */
//         .footer { background:#111;color:white;padding:60px 64px 40px; }
//         .footer-top { display:flex;justify-content:space-between;margin-bottom:48px; }
//         .footer-logo { font-size:22px;font-weight:800;color:#ef4444;letter-spacing:-0.5px; }
//         .footer-tagline { font-size:14px;color:#666;margin-top:8px; }
//         .footer-links { display:flex;gap:60px; }
//         .footer-col-title { font-size:12px;font-weight:700;color:#555;letter-spacing:2px;text-transform:uppercase;margin-bottom:16px; }
//         .footer-link { font-size:14px;color:#666;cursor:pointer;transition:color 0.2s;display:block;margin-bottom:10px; }
//         .footer-link:hover { color:#ef4444; }
//         .footer-bottom { border-top:1px solid #222;padding-top:32px;display:flex;justify-content:space-between;align-items:center; }
...
//         @media (max-width:1024px) { .hero-visual{display:none} .nav-links{display:none} .stats-grid{grid-template-columns:repeat(2,1fr)} .features-grid{grid-template-columns:repeat(2,1fr)} .steps-wrapper{grid-template-columns:1fr} .steps-visual{display:none} .testimonials-grid{grid-template-columns:1fr} .footer-links{gap:32px} }
//         @media (max-width:768px) { .nav{padding:0 24px} .hero{padding:100px 24px 60px} .stats-section{padding:60px 24px} .section{padding:80px 24px} .features-grid{grid-template-columns:1fr} .map-section{padding:80px 24px} .cta-section{padding:80px 24px} .footer{padding:48px 24px 32px} .footer-top{flex-direction:column;gap:40px} .footer-links{flex-direction:column;gap:32px} .footer-bottom{flex-direction:column;gap:16px;text-align:center} .impact-inner{padding:80px 24px} }
//       `}</style>
...
//         </div>
//         <div className="hero-content">
//           <div className="hero-badge"><span className="heartbeat">🩸</span>Connecting Lives in Real Time</div>
//           <h1 className="hero-title">Connecting Lives,<br /><span className="gradient-text">One Drop at a Time.</span></h1>
//           <p className="hero-sub">RedThread matches blood donors with hospitals and patients instantly — based on location, blood type, and availability. Because every second matters.</p>
//           <div className="hero-btns">
//             <button className="btn-hero-primary" onClick={() => navigate('/register')}>🩸 Find Donors</button>
...
//       {/* Features */}
//       <div className="features-bg" id="features" data-section="features">
//         <div className="section">
//           <div className={`reveal ${isVisible('features') ? 'visible' : ''}`}>
//             <div className="section-tag">Why RedThread</div>
//             <h2 className="section-title">Everything you need<br />to save a life.</h2>
...
//       {/* Steps - Interactive */}
//       <div className="steps-bg" id="how" data-section="steps">
//         <div className="section">
//           <div className={`reveal ${isVisible('steps') ? 'visible' : ''}`}>
//             <div className="section-tag">How it works</div>
//             <h2 className="section-title">Simple steps.<br />Life-saving results.</h2>
...
//                     <div style={{ animation: 'fadeUp 0.4s ease' }}>
//                       <div className="phone-header"><div className="phone-logo">RedThread 🩸</div><div className="phone-status">● Live</div></div>
//                       <div style={{ fontSize: 18, fontWeight: 800, marginBottom: 16, color: '#111' }}>Create Account</div>
//                       {['Full Name', 'Email', 'Phone'].map((p, i) => (
//                         <div key={i} style={{ background: '#f9fafb', border: '1.5px solid #e5e7eb', borderRadius: 10, padding: '10px 14px', marginBottom: 10, fontSize: 13, color: '#999' }}>{p}</div>
//                       ))}
...
//                   {activeStep === 1 && (
//                     <div style={{ animation: 'fadeUp 0.4s ease' }}>
//                       <div className="phone-header"><div className="phone-logo">RedThread 🩸</div><div className="phone-status">✓ Registered</div></div>
//                       <div style={{ fontSize: 16, fontWeight: 800, marginBottom: 16, color: '#111' }}>Set Your Profile</div>
//                       <div style={{ marginBottom: 12 }}>
//                         <div style={{ fontSize: 11, fontWeight: 700, color: '#999', marginBottom: 6, textTransform: 'uppercase', letterSpacing: 1 }}>Blood Type</div>
//                         <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
//                           {['A+', 'A-', 'B+', 'B-', 'O+', 'O-', 'AB+', 'AB-'].map((bt, i) => (
//                             <div key={i} style={{ padding: '6px 10px', borderRadius: 8, fontSize: 12, fontWeight: 700, background: bt === 'O-' ? '#B91C1C' : '#f3f4f6', color: bt === 'O-' ? 'white' : '#666' }}>{bt}</div>
//                           ))}
//                         </div>
//                       </div>
//                       <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 10, padding: 12, fontSize: 12, color: '#16a34a', fontWeight: 600, marginTop: 12 }}>📍 Location captured — Delhi NCR</div>
//                       <div style={{ background: '#B91C1C', color: 'white', padding: '12px', borderRadius: 12, textAlign: 'center', fontSize: 14, fontWeight: 700, marginTop: 16 }}>Save Profile →</div>
//                     </div>
//                   )}
//                   {activeStep === 2 && (
//                     <div style={{ animation: 'fadeUp 0.4s ease' }}>
//                       <div className="phone-header"><div className="phone-logo">RedThread 🩸</div><div className="phone-status">● Active</div></div>
//                       <div style={{ background: '#fef2f2', border: '1.5px solid #fecaca', borderRadius: 16, padding: 16, marginBottom: 12 }}>
//                         <div style={{ fontSize: 11, fontWeight: 700, color: '#B91C1C', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 }}>🚨 Urgent Request</div>
//                         <div style={{ fontSize: 28, fontWeight: 900, color: '#B91C1C', letterSpacing: -1 }}>O−</div>
//                         <div style={{ fontSize: 12, color: '#666', marginTop: 4 }}>🏥 Apollo Hospital · 2.4km</div>
//                         <div style={{ fontSize: 11, color: '#B91C1C', fontWeight: 600, marginTop: 6 }}>Critical · Just now</div>
//                       </div>
//                       <div style={{ display: 'flex', gap: 8 }}>
//                         <div style={{ flex: 1, background: '#B91C1C', color: 'white', padding: '10px', borderRadius: 10, textAlign: 'center', fontSize: 13, fontWeight: 700 }}>✅ Accept</div>
//                         <div style={{ flex: 1, background: '#f3f4f6', color: '#666', padding: '10px', borderRadius: 10, textAlign: 'center', fontSize: 13 }}>❌ Reject</div>
...
//                         <div style={{ fontSize: 56, marginBottom: 12, animation: 'heartbeat 1s ease infinite' }}>🩸</div>
//                         <div style={{ fontSize: 20, fontWeight: 900, color: '#111', marginBottom: 8 }}>You're a Hero!</div>
//                         <div style={{ fontSize: 13, color: '#666', lineHeight: 1.6 }}>You've accepted the request. Head to Apollo Hospital now.</div>
//                         <div style={{ background: '#f0fdf4', border: '1px solid #bbf7d0', borderRadius: 12, padding: 12, marginTop: 16, fontSize: 12, color: '#16a34a', fontWeight: 600 }}>✅ Hospital has been notified</div>
//                       </div>
//                     </div>
//                   )}
//                 </div>
...
//       {/* Impact / Testimonials */}
//       <div className="impact-bg" id="impact" data-section="impact">
//         <div className="impact-bg-pattern" />
//         <div className="impact-inner">
//           <div className={`reveal ${isVisible('impact') ? 'visible' : ''}`} style={{ color: 'rgba(255,255,255,0.6)' }}>
//             <div className="section-tag" style={{ color: 'rgba(255,255,255,0.6)' }}>Real Stories</div>
//           </div>
//           <h2 className={`impact-title reveal ${isVisible('impact') ? 'visible' : ''}`} style={{ transitionDelay: '100ms' }}>Lives changed<br />by RedThread.</h2>
//           <p className={`impact-sub reveal ${isVisible('impact') ? 'visible' : ''}`} style={{ transitionDelay: '200ms' }}>Real stories from donors, patients, and hospitals who experienced the power of fast, hyperlocal matching.</p>
...
//             <div className="section-tag">Live Donor Map</div>
//             <h2 className="section-title">Donors near you,<br />right now.</h2>
//             <p className="section-sub">Real-time donor availability across your city. Every dot is a potential lifesaver. Hover to see details.</p>
//           </div>
//           <div className={`map-container reveal-scale ${isVisible('map') ? 'visible' : ''}`} style={{ transitionDelay: '200ms' }}>
//             <div className="map-bg-grad" />
//             <div className="map-grid" />
...
//               <path d="M 0 160 Q 400 140 800 180" stroke="rgba(185,28,28,0.05)" strokeWidth="2" fill="none" />
//               <path d="M 0 320 Q 300 300 600 340 T 900 310" stroke="rgba(185,28,28,0.05)" strokeWidth="2" fill="none" />
//               {/* Connection line from hospital to nearest donor */}
//               <line x1="50%" y1="50%" x2={`${mapDots[activeDotIndex].x}%`} y2={`${mapDots[activeDotIndex].y}%`} stroke="#B91C1C" strokeWidth="1.5" strokeDasharray="6 4" opacity="0.5">
//                 <animate attributeName="stroke-dashoffset" from="0" to="-20" dur="1s" repeatCount="indefinite" />
//               </line>
//             </svg>
...
//             <div style={{ position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%,-50%)', zIndex: 3 }}>
//               <div style={{ width: 36, height: 36, background: 'white', border: '2.5px solid #B91C1C', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16, boxShadow: '0 4px 16px rgba(185,28,28,0.25)' }}>🏥</div>
//               <div style={{ position: 'absolute', bottom: -24, left: '50%', transform: 'translateX(-50%)', fontSize: 10, fontWeight: 700, color: '#B91C1C', whiteSpace: 'nowrap', background: 'white', padding: '2px 6px', borderRadius: 4, boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>Apollo Hospital</div>
//             </div>
...
//             <div className="map-title">🗺 Delhi NCR — Live View</div>
//             <div className="map-count">🟢 {mapDots.filter(d => d.active).length} Active Donors</div>
//             <div className="map-legend">
//               <div className="legend-item"><div className="legend-dot" style={{ background: '#B91C1C' }} />Available donor</div>
//               <div className="legend-item"><div className="legend-dot" style={{ background: '#d1d5db' }} />Unavailable donor</div>
//               <div className="legend-item"><div style={{ fontSize: 12 }}>🏥</div>Hospital</div>
//             </div>
//             <div className="map-request">
//               <div className="map-req-title">🚨 Active Request</div>
//               <div className="map-req-detail">Apollo Hospital · O− Blood</div>
//               <div className="map-req-badge">Critical · {mapDots.filter(d => d.active)[activeDotIndex % mapDots.filter(d => d.active).length]?.name} responding</div>
//             </div>
...
//   const features = [
//     { icon: '⚡', title: 'Real-Time Matching', desc: 'Instant donor-to-hospital connections based on blood type and proximity.' },
//     { icon: '📍', title: 'Location-Based Search', desc: 'Hyperlocal 10km radius matching finds donors who can actually arrive in time.' },
//     { icon: '🔔', title: 'Emergency Alerts', desc: 'Critical requests trigger immediate email notifications to all matching donors.' },
//     { icon: '✅', title: 'Verified Donors', desc: 'Every donor profile is verified with blood type and availability status.' },
//     { icon: '🏥', title: 'Hospital Dashboard', desc: 'Hospitals manage requests, track responses, and coordinate donations seamlessly.' },
//     { icon: '📊', title: 'Donation History', desc: 'Complete audit trail of every donation and request for transparency.' },
//   ]

//   const steps = [
//     { num: '01', title: 'Register', desc: 'Sign up as a donor or hospital. Takes under 2 minutes.', color: '#B91C1C' },
//     { num: '02', title: 'Set Profile', desc: 'Donors set blood type, location, and availability status.', color: '#991B1B' },
//     { num: '03', title: 'Get Matched', desc: 'Hospitals post requests. Nearby donors get notified instantly.', color: '#7F1D1D' },
//     { num: '04', title: 'Save a Life', desc: 'Donor accepts, heads to hospital. A life is saved.', color: '#450A0A' },
//   ]

//   const testimonials = [
//     { quote: "RedThread notified me within seconds. I was at the hospital in 20 minutes. The patient survived.", name: "Arjun Mehta", role: "Blood Donor, Delhi" },
//     { quote: "We posted a critical O- request at 2am. Three donors responded within minutes. This platform is incredible.", name: "Dr. Priya Sharma", role: "Chief Surgeon, Apollo Hospital" },
//     { quote: "My daughter needed a rare blood type. RedThread found a matching donor 4km away in under 5 minutes.", name: "Sunita Kapoor", role: "Patient's Mother, Mumbai" },
//   ]

//   const mapDots = [
//     { x: 28, y: 35, size: 'lg', active: true },
//     { x: 45, y: 28, size: 'md', active: true },
//     { x: 62, y: 42, size: 'sm', active: false },
//     { x: 35, y: 55, size: 'md', active: true },
//     { x: 72, y: 30, size: 'lg', active: true },
//     { x: 55, y: 65, size: 'sm', active: true },
//     { x: 20, y: 60, size: 'md', active: false },
//     { x: 80, y: 55, size: 'sm', active: true },
//     { x: 48, y: 75, size: 'md', active: true },
//     { x: 15, y: 45, size: 'sm', active: false },
//     { x: 68, y: 72, size: 'lg', active: true },
//     { x: 38, y: 20, size: 'sm', active: true },
//   ]
...
//           color: #B91C1C; padding: 8px 18px; border-radius: 100px;
...
//         }
//         .hero-sub {
//           font-size: 18px; color: #666; line-height: 1.7; max-width: 520px;
...
//         .btn-hero-primary:hover { background: #991B1B; transform: translateY(-3px); box-shadow: 0 16px 40px rgba(185,28,28,0.45); }
//         .btn-hero-secondary {
//           background: white; color: #B91C1C; border: 2px solid rgba(185,28,28,0.2);
...
//           box-shadow: 0 20px 60px rgba(0,0,0,0.1); position: absolute;
//         }
//         .hero-card-main {
//           width: 300px; top: 50%; left: 50%; transform: translate(-50%, -50%);
//         }
//         .hero-card-notify {
//           width: 220px; top: 10%; right: 0;
//           animation: float 4s ease infinite;
//         }
//         .hero-card-donor {
//           width: 200px; bottom: 10%; left: 0;
//           animation: float 4s ease 2s infinite;
//         }
//         @keyframes float {
...
//         }
//         .ring {
//           position: absolute; border-radius: 50%; border: 1px solid rgba(185,28,28,0.15);
...
//         /* Stats */
//         .stats-section {
//           padding: 80px 64px; background: white;
...
//           cursor: default;
//         }
//         .feature-card:hover { transform: translateY(-6px); box-shadow: 0 20px 60px rgba(185,28,28,0.1); border-color: rgba(185,28,28,0.2); }
...
//           background: linear-gradient(90deg, #B91C1C, #ef4444, #fca5a5, #fecaca);
//         }
//         .step-item { padding: 0 24px; text-align: center; position: relative; }
//         .step-circle {
//           width: 80px; height: 80px; border-radius: 50%; margin: 0 auto 24px;
//           display: flex; align-items: center; justify-content: center;
//           font-size: 22px; font-weight: 900; color: white; position: relative; z-index: 1;
...
//         /* Impact */
//         .impact-bg { background: linear-gradient(135deg, #7F1D1D 0%, #B91C1C 50%, #DC2626 100%); }
//         .impact-inner { padding: 120px 64px; max-width: 1200px; margin: 0 auto; }
//         .impact-title { font-size: clamp(36px, 5vw, 64px); font-weight: 900; color: white; letter-spacing: -2px; margin-bottom: 20px; }
//         .impact-sub { font-size: 18px; color: rgba(255,255,255,0.7); max-width: 520px; line-height: 1.7; margin-bottom: 64px; }
//         .testimonials-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; }
//         .testimonial-card {
//           background: rgba(255,255,255,0.1); backdrop-filter: blur(20px);
//           border: 1px solid rgba(255,255,255,0.15); border-radius: 20px; padding: 32px;
//           transition: all 0.3s;
//         }
...
//         .map-inner { max-width: 1200px; margin: 0 auto; }
//         .map-container {
//           margin-top: 64px; background: white; border-radius: 24px;
...
//         .map-grid {
//           position: absolute; inset: 0;
//           background-image: linear-gradient(rgba(185,28,28,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(185,28,28,0.04) 1px, transparent 1px);
//           background-size: 40px 40px;
//         }
//         .map-dot { position: absolute; border-radius: 50%; transform: translate(-50%, -50%); }
//         .map-dot.active { background: #B91C1C; }
//         .map-dot.inactive { background: #d1d5db; }
//         .map-dot.lg { width: 16px; height: 16px; }
//         .map-dot.md { width: 12px; height: 12px; }
//         .map-dot.sm { width: 8px; height: 8px; }
//         .map-dot.active.lg { box-shadow: 0 0 0 6px rgba(185,28,28,0.15); animation: mapPulse 2s ease infinite; }
//         .map-dot.active.md { box-shadow: 0 0 0 4px rgba(185,28,28,0.12); animation: mapPulse 2s ease 0.5s infinite; }
//         @keyframes mapPulse {
//           0%, 100% { box-shadow: 0 0 0 4px rgba(185,28,28,0.15); }
//           50% { box-shadow: 0 0 0 10px rgba(185,28,28,0.05); }
//         }
//         .map-legend {
//           position: absolute; bottom: 24px; right: 24px;
//           background: white; border-radius: 12px; padding: 16px 20px;
//           box-shadow: 0 4px 20px rgba(0,0,0,0.1); font-size: 13px;
//         }
//         .legend-item { display: flex; align-items: center; gap: 8px; margin-bottom: 8px; color: #555; }
//         .legend-item:last-child { margin-bottom: 0; }
//         .legend-dot { width: 10px; height: 10px; border-radius: 50%; flex-shrink: 0; }
...
//           box-shadow: 0 4px 20px rgba(0,0,0,0.1); font-size: 14px; font-weight: 700; color: #111;
//         }
//         .map-count {
//           position: absolute; top: 24px; right: 24px;
//           background: #B91C1C; border-radius: 12px; padding: 10px 16px;
...
//           .impact-inner { padding: 80px 24px; }
//         }
//       `}</style>
...
//             based on location, blood type, and availability. Because every second matters.
//           </p>
...
//         {/* Floating cards */}
//         <div className="hero-visual">
//           <div className="ring" style={{ width: 300, height: 300, animationDelay: '0s' }} />
//           <div className="ring" style={{ width: 420, height: 420, animationDelay: '1s' }} />
...
//             <div className="blood-type">O−</div>
//             <div className="card-sub">🏥 Apollo Hospital, Delhi</div>
//             <div style={{ marginTop: 16, padding: '10px 16px', background: '#fef2f2', borderRadius: 10, fontSize: 13, color: '#B91C1C', fontWeight: 600 }}>
...
//       {/* Stats */}
//       <div className="stats-section" ref={statsRef} id="impact-stats">
//         <div className="stats-grid">
//           <div className="stat-item">
//             <div className="stat-num">{counts.donors.toLocaleString()}+</div>
//             <div className="stat-label">Registered Donors</div>
//           </div>
//           <div className="stat-item">
//             <div className="stat-num">{counts.lives}+</div>
//             <div className="stat-label">Lives Saved</div>
//           </div>
//           <div className="stat-item">
//             <div className="stat-num">{counts.hospitals}+</div>
//             <div className="stat-label">Partner Hospitals</div>
//           </div>
//           <div className="stat-item">
//             <div className="stat-num">{counts.cities}+</div>
...
//                 <div className="step-circle" style={{ background: `linear-gradient(135deg, ${s.color}, #ef4444)` }}>
//                   {s.num}
//                 </div>
//                 <div className="step-title">{s.title}</div>
...
//         <div className="impact-inner">
//           <div className="section-tag" style={{ color: 'rgba(255,255,255,0.6)' }}>Real Stories</div>
//           <h2 className="impact-title">Lives changed<br />by RedThread.</h2>
//           <p className="impact-sub">These are real stories from donors, patients, and hospitals who experienced the power of fast, hyperlocal matching.</p>
//           <div className="testimonials-grid">
//             {testimonials.map((t, i) => (
...
//           <div className="section-tag">Live Donor Map</div>
//           <h2 className="section-title">Donors near you,<br />right now.</h2>
//           <p className="section-sub">RedThread shows real-time donor availability in your area. Every dot is a potential lifesaver.</p>
...
//               <div
//                 key={i}
//                 className={`map-dot ${dot.active ? 'active' : 'inactive'} ${dot.size}`}
...
//         <h1 className="text-2xl font-bold text-red-600">RedThread 🩸</h1>
...
//           Save Lives with <span className="text-red-600">RedThread</span>
//         </h2>
//         <p className="text-xl text-gray-500 mb-10 max-w-2xl mx-auto">
//           Connecting blood and organ donors with hospitals in real time.
//           Every second counts — be the reason someone survives.
//         </p>
//         <div className="flex gap-4 justify-center">
//           <button
//             onClick={() => navigate('/register')}
//             className="bg-red-600 text-white px-8 py-3 rounded-xl font-semibold text-lg hover:bg-red-700 transition"
//           >
//             Become a Donor
//           </button>
//           <button
//             onClick={() => navigate('/register')}
//             className="border border-red-600 text-red-600 px-8 py-3 rounded-xl font-semibold text-lg hover:bg-red-50 transition"
//           >
//             I am a Hospital
//           </button>
//         </div>
...
//             <h3 className="text-lg font-bold text-gray-800 mb-2">Hyperlocal Matching</h3>
//             <p className="text-gray-500 text-sm">Find donors near you instantly based on real road distance and travel time.</p>
//           </div>

//           <div className="bg-white rounded-2xl shadow-sm p-6 text-center">
//             <div className="text-4xl mb-4">🔔</div>
//             <h3 className="text-lg font-bold text-gray-800 mb-2">Instant Notifications</h3>
//             <p className="text-gray-500 text-sm">Nearby donors get notified instantly via email when a hospital posts an urgent request.</p>
//           </div>

//           <div className="bg-white rounded-2xl shadow-sm p-6 text-center">
//             <div className="text-4xl mb-4">🩸</div>
//             <h3 className="text-lg font-bold text-gray-800 mb-2">Blood & Organ Donation</h3>
//             <p className="text-gray-500 text-sm">Support both blood and organ donation requests with urgency levels.</p>
//           </div>
...
//             <h3 className="text-lg font-bold text-red-600 mb-4">For Donors 🙋</h3>
//             <div className="space-y-3">
//               <div className="flex items-start gap-3">
//                 <span className="bg-red-100 text-red-600 font-bold px-2 py-1 rounded-lg text-sm">1</span>
//                 <p className="text-gray-600 text-sm">Register and set your blood type and location</p>
//               </div>
//               <div className="flex items-start gap-3">
//                 <span className="bg-red-100 text-red-600 font-bold px-2 py-1 rounded-lg text-sm">2</span>
//                 <p className="text-gray-600 text-sm">Get notified instantly when a nearby hospital needs your blood type</p>
//               </div>
//               <div className="flex items-start gap-3">
//                 <span className="bg-red-100 text-red-600 font-bold px-2 py-1 rounded-lg text-sm">3</span>
//                 <p className="text-gray-600 text-sm">Accept the request and save a life!</p>
//               </div>
//             </div>
//           </div>
...
//           {/* For Hospitals */}
//           <div className="bg-white rounded-2xl shadow-sm p-6">
//             <h3 className="text-lg font-bold text-red-600 mb-4">For Hospitals 🏥</h3>
//             <div className="space-y-3">
//               <div className="flex items-start gap-3">
//                 <span className="bg-red-100 text-red-600 font-bold px-2 py-1 rounded-lg text-sm">1</span>
//                 <p className="text-gray-600 text-sm">Register your hospital on RedThread</p>
//               </div>
//               <div className="flex items-start gap-3">
//                 <span className="bg-red-100 text-red-600 font-bold px-2 py-1 rounded-lg text-sm">2</span>
//                 <p className="text-gray-600 text-sm">Post an urgent blood or organ request with urgency level</p>
//               </div>
//               <div className="flex items-start gap-3">
//                 <span className="bg-red-100 text-red-600 font-bold px-2 py-1 rounded-lg text-sm">3</span>
//                 <p className="text-gray-600 text-sm">Nearby donors get notified and can accept your request instantly</p>
//               </div>
//             </div>
//           </div>
...
//         <p>Made with ❤️ to save lives — RedThread 🩸</p>
//       </div>

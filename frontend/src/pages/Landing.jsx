...
const Landing = () => {
  ...
  const features = [
    { icon: '⚡', title: 'Real-Time Matching', desc: 'Instant donor-to-hospital connections based on blood type and proximity within seconds.', bg: '#fef2f2', border: '#fecaca' },
    { icon: '📍', title: 'Location-Based Search', desc: 'Hyperlocal 10km radius matching finds donors who can actually arrive in time.', bg: '#fff7ed', border: '#fed7aa' },
    { icon: '🔔', title: 'Emergency Alerts', desc: 'Critical requests trigger immediate email notifications to all matching donors.', bg: '#fdf4ff', border: '#e9d5ff' },
    { icon: '✅', title: 'Verified Donors', desc: 'Every donor profile verified with blood type and real-time availability status.', bg: '#f0fdf4', border: '#bbf7d0' },
    { icon: '🏥', title: 'Hospital Dashboard', desc: 'Hospitals manage requests, track responses, and coordinate donations seamlessly.', bg: '#eff6ff', border: '#bfdbfe' },
    { icon: '📊', title: 'Donation History', desc: 'Complete audit trail of every donation and request for full transparency.', bg: '#fefce8', border: '#fde68a' },
  ]
  ...
  return (
    <div className="font-inter bg-[#fafafa] text-[#111] overflow-x-hidden">
      ...
      {/* ─── Navbar ─── */}
      <nav className={`fixed top-0 left-0 right-0 z-[100] px-[clamp(16px,4vw,64px)] h-[68px] flex justify-between items-center transition-all duration-300 ${scrollY > 20 ? 'bg-white/95 backdrop-blur-xl shadow-[0_1px_40px_rgba(0,0,0,0.08)]' : ''}`}>
        <div
      ...
      <section
        ...
        style={{ background: 'linear-gradient(135deg,#fff 0%,#fff5f5 50%,#fff 100%)' }}
      >
        {/* Background circles */}
        <div
        ...
        {/* Two-column wrapper */}
        <div className="relative z-[1] w-full flex items-center justify-between gap-8">
 ...
 <div className="inline-flex items-center gap-2 bg-[rgba(185,28,28,0.08)] border border-[rgba(185,28,28,0.2)] text-[#B91C1C] px-4 py-2 rounded-full text-[clamp(11px,1.5vw,13px)] font-semibold mb-[clamp(16px,3vh,28px)] max-w-full">
  <span className="badge-text-span">Connecting Lives in Real Time</span>
          ...
          <p className="text-[clamp(15px,1.6vw,18px)] text-[#666] leading-[1.7] max-w-[520px] mb-[clamp(24px,4vh,40px)] font-normal hero-sub-anim">
            RedThread matches blood donors with hospitals and patients instantly — based on location, blood type, and availability. Because every second matters.
          </p>
        ...
        <div className="hero-visual relative flex-shrink-0 w-[clamp(320px,38vw,520px)] h-[clamp(320px,38vw,520px)] anim-fade-in">
          {/* Rings */}
          <div className="anim-ring absolute rounded-full border border-[rgba(185,28,28,0.15)]"
            style={{ width: 300, height: 300, top: '50%', left: '50%', transform: 'translate(-50%,-50%)' }} />
          <div className="anim-ring-delay absolute rounded-full border border-[rgba(185,28,28,0.15)]"
          ...
          <div className="bg-white rounded-[20px] p-[clamp(16px,2vw,24px)] shadow-[0_20px_60px_rgba(0,0,0,0.1)] absolute w-[clamp(200px,22vw,300px)] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <div className="text-[11px] font-bold text-[#999] tracking-[1px] uppercase mb-[10px]">Blood Request — Critical</div>
            <div className="text-[clamp(32px,4vw,48px)] font-black text-[#B91C1C] tracking-[-2px] leading-none">O−</div>
            <div className="text-[clamp(11px,1.2vw,13px)] text-[#666] mt-2">🏥 Apollo Hospital, Delhi</div>
            <div className="mt-4 px-4 py-[10px] bg-[#fef2f2] rounded-[10px] text-[13px] text-[#B91C1C] font-semibold">⚡ 3 donors notified nearby</div>
          </div>
          ...
          <div className="bg-white rounded-[20px] p-[clamp(16px,2vw,24px)] shadow-[0_20px_60px_rgba(0,0,0,0.1)] absolute w-[clamp(160px,18vw,220px)] top-[10%] right-0 anim-float">
            ...
            <div className="text-[clamp(12px,1.3vw,14px)] font-bold text-[#111]">Urgent Request Nearby!</div>
            <div className="text-[clamp(10px,1.1vw,12px)] text-[#666] mt-1">Apollo Hospital needs O− blood</div>
            <div className="text-[clamp(10px,1vw,11px)] text-[#B91C1C] font-semibold mt-2">Just now · 2.4km away</div>
          </div>
          ...
          <div className="bg-white rounded-[20px] p-[clamp(16px,2vw,24px)] shadow-[0_20px_60px_rgba(0,0,0,0.1)] absolute w-[clamp(150px,16vw,200px)] bottom-[10%] left-0 anim-float-delay">
            <div className="text-[clamp(13px,1.4vw,15px)] font-bold text-[#111]">Arjun Mehta</div>
            <div className="text-[clamp(10px,1.1vw,12px)] text-[#666] mt-1">🩸 O− · Available Now</div>
            <div className="inline-block bg-[#dcfce7] text-[#16a34a] text-[clamp(9px,1vw,11px)] font-bold px-[10px] py-[3px] rounded-full mt-2">✓ Verified Donor</div>
          </div>
        </div>
      ...
      {/* ─── Stats ─── */}
      <div ref={statsRef} className="py-[clamp(40px,6vh,80px)] px-[clamp(16px,4vw,64px)] bg-white border-t border-b border-[#f0f0f0]">
        <div className="grid grid-cols-2 md:grid-cols-4 max-w-[1100px] mx-auto">
          {[
            ...
            <div
              ...
              style={{
                borderRight: i === 1 ? (window.innerWidth <= 768 ? 'none' : undefined) : undefined,
                borderLeft:  (i === 1 || i === 3) ? (window.innerWidth <= 768 ? 'none' : undefined) : undefined,
              }}
            >
              <div
              ...
              <div className="text-[clamp(11px,1.2vw,14px)] text-[#888] font-medium mt-2">{s.label}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      >
        <div className="max-w-[1200px] mx-auto">
          <div className={`reveal ${isVisible('features') ? 'visible' : ''}`}>
            <div className="text-[clamp(10px,1.2vw,12px)] font-bold text-[#B91C1C] tracking-[3px] uppercase mb-4">Why RedThread</div>
            <h2 className="text-[clamp(26px,4vw,52px)] font-extrabold tracking-tight leading-[1.1] mb-4">Everything you need<br />to save a life.</h2>
            <p className="text-[clamp(14px,1.6vw,16px)] text-[#666] max-w-[480px] leading-[1.7]">Built for speed, reliability, and real-world impact in critical medical situations.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[clamp(12px,2vw,20px)] mt-[clamp(32px,5vh,64px)]">
            {features.map((f, i) => (
              ...
              >
                <span className="feature-icon text-[clamp(28px,3.5vw,40px)] mb-[clamp(12px,2vh,20px)] block">{f.icon}</span>
                <div className="text-[clamp(15px,1.8vw,18px)] font-bold mb-[10px] tracking-[-0.3px]">{f.title}</div>
                <div className="text-[clamp(13px,1.4vw,14px)] text-[#666] leading-[1.7]">{f.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        <div className="max-w-[1200px] mx-auto">
          <div className={`reveal ${isVisible('steps') ? 'visible' : ''}`}>
            <div className="text-[clamp(10px,1.2vw,12px)] font-bold text-[#B91C1C] tracking-[3px] uppercase mb-4">How it works</div>
            <h2 className="text-[clamp(26px,4vw,52px)] font-extrabold tracking-tight leading-[1.1] mb-4">Simple steps.<br />Life-saving results.</h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[clamp(32px,6vw,80px)] items-center mt-[clamp(32px,5vh,64px)]">
              ...
              {steps.map((s, i) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="text-[clamp(9px,1vw,11px)] font-bold text-[#B91C1C] tracking-[2px] uppercase mb-1">{s.num}</div>
                    <div className="text-[clamp(15px,1.8vw,18px)] font-bold mb-[6px]">{s.title}</div>
                    {activeStep === i && (
                      <div className="text-[clamp(12px,1.4vw,14px)] text-[#666] leading-[1.6] step-desc-anim">{s.desc}</div>
                    )}
                  </div>
                </div>
              ))}
            ...
            <div className="steps-visual relative h-[clamp(340px,40vw,460px)] flex items-center justify-center">
              <div className="w-[clamp(200px,22vw,260px)] bg-white rounded-[32px] shadow-[0_32px_80px_rgba(0,0,0,0.15)] overflow-hidden border-[8px] border-[#111] transition-all duration-500">
                ...
                <div className="p-[clamp(14px,2vw,20px)] min-h-[clamp(300px,35vw,400px)]" style={{ background: 'linear-gradient(135deg,#fff5f5,#fff)' }}>
                  {activeStep === 0 && (
                    <div className="phone-content-anim">
                      ...
                      {['Full Name', 'Email', 'Phone'].map((p, i) => (
                        <div key={i} className="bg-[#f9fafb] border-[1.5px] border-[#e5e7eb] rounded-[10px] px-[14px] py-[10px] mb-2 text-[13px] text-[#999]">{p}</div>
                      ))}
                      <div className="flex gap-2 mb-[14px]">
                        <div className="flex-1 bg-[#B91C1C] text-white py-[10px] rounded-[10px] text-center text-[13px] font-bold">Donor</div>
                        <div className="flex-1 bg-[#f3f4f6] text-[#666] py-[10px] rounded-[10px] text-center text-[13px]">Hospital</div>
                      </div>
                      <div className="bg-[#B91C1C] text-white py-3 rounded-[12px] text-center text-[14px] font-bold">Register →</div>
                    </div>
                  )}
                  {activeStep === 1 && (
                    <div className="phone-content-anim">
                      ...
                      <div className="text-[11px] font-bold text-[#999] mb-2 uppercase tracking-[1px]">Blood Type</div>
                      <div className="flex flex-wrap gap-[5px] mb-3">
                        {['A+', 'A-', 'B+', 'B-', 'O+', 'O-', 'AB+', 'AB-'].map((bt, i) => (
                          <div key={i} className={`px-2 py-[5px] rounded-[8px] text-[11px] font-bold ${bt === 'O-' ? 'bg-[#B91C1C] text-white' : 'bg-[#f3f4f6] text-[#666]'}`}>{bt}</div>
                        ))}
                      </div>
                      <div className="bg-[#f0fdf4] border border-[#bbf7d0] rounded-[10px] p-[10px] text-[12px] text-[#16a34a] font-semibold">📍 Location captured — Delhi NCR</div>
                      <div className="bg-[#B91C1C] text-white py-3 rounded-[12px] text-center text-[14px] font-bold mt-3">Save →</div>
                    </div>
                  )}
                  {activeStep === 2 && (
                    <div className="phone-content-anim">
                      ...
                      <div className="bg-[#fef2f2] border-[1.5px] border-[#fecaca] rounded-[14px] p-[14px] mb-3">
                        <div className="text-[10px] font-bold text-[#B91C1C] uppercase tracking-[1px] mb-[6px]">🚨 Urgent Request</div>
                        <div className="text-[26px] font-black text-[#B91C1C] tracking-[-1px]">O−</div>
                        <div className="text-[12px] text-[#666] mt-[3px]">🏥 Apollo Hospital · 2.4km</div>
                        <div className="text-[10px] text-[#B91C1C] font-semibold mt-1">Critical · Just now</div>
                      </div>
                      <div className="flex gap-2">
                        <div className="flex-1 bg-[#B91C1C] text-white py-[10px] rounded-[10px] text-center text-[13px] font-bold">✅ Accept</div>
                        <div className="flex-1 bg-[#f3f4f6] text-[#666] py-[10px] rounded-[10px] text-center text-[13px]">❌ Reject</div>
                      </div>
                    </div>
                  )}
                  {activeStep === 3 && (
      ...
      >
        ...
        <div className="max-w-[1200px] mx-auto relative">
          <div className={`reveal ${isVisible('impact') ? 'visible' : ''}`}>
            <div className="text-[clamp(10px,1.2vw,12px)] font-bold text-[rgba(255,255,255,0.6)] tracking-[3px] uppercase mb-4">Real Stories</div>
          </div>
          <h2 className={`text-[clamp(28px,5vw,64px)] font-black text-white tracking-[-2px] mb-5 reveal ${isVisible('impact') ? 'visible' : ''}`} style={{ transitionDelay: '100ms' }}>
            Lives changed<br />by RedThread.
          </h2>
          <p className={`text-[clamp(14px,1.8vw,18px)] text-[rgba(255,255,255,0.7)] max-w-[520px] leading-[1.7] mb-[clamp(32px,5vh,64px)] reveal ${isVisible('impact') ? 'visible' : ''}`} style={{ transitionDelay: '200ms' }}>
            Real stories from donors, patients, and hospitals who experienced the power of fast, hyperlocal matching.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[clamp(12px,2vw,24px)]">
            {testimonials.map((t, i) => (
              ...
              >
                <div className="text-[clamp(36px,4vw,48px)] text-[rgba(255,255,255,0.3)] leading-none mb-4 font-serif">"</div>
                <div className="text-[clamp(13px,1.5vw,15px)] text-[rgba(255,255,255,0.9)] leading-[1.7] mb-6 italic">{t.quote}</div>
                <div className="w-10 h-10 rounded-full bg-[rgba(255,255,255,0.2)] flex items-center justify-center text-[14px] font-extrabold text-white mb-[10px]">{t.avatar}</div>
                <div className="text-[clamp(13px,1.4vw,14px)] font-bold text-white">{t.name}</div>
                <div className="text-[clamp(11px,1.2vw,12px)] text-[rgba(255,255,255,0.6)] mt-1">{t.role}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      >
        <div className="max-w-[1200px] mx-auto">
          <div className={`reveal ${isVisible('map') ? 'visible' : ''}`}>
            <div className="text-[clamp(10px,1.2vw,12px)] font-bold text-[#B91C1C] tracking-[3px] uppercase mb-4">Live Donor Map</div>
            <h2 className="text-[clamp(26px,4vw,52px)] font-extrabold tracking-tight leading-[1.1] mb-4">Donors near you,<br />right now.</h2>
            <p className="text-[clamp(14px,1.6vw,16px)] text-[#666] max-w-[480px] leading-[1.7]">Real-time donor availability across your city. Every dot is a potential lifesaver.</p>
          </div>

          <div
            className={`relative mt-[clamp(32px,5vh,64px)] bg-white rounded-[24px] border-2 border-[#fecaca] overflow-hidden shadow-[0_20px_60px_rgba(185,28,28,0.1)] h-[clamp(320px,45vw,480px)] reveal-scale ${isVisible('map') ? 'visible' : ''}`}
            style={{ transitionDelay: '200ms' }}
          >
            {/* Map background */}
            <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg,#f8fafc 0%,#fff5f5 50%,#f8fafc 100%)' }} />
            <div
              className="absolute inset-0"
              style={{
                backgroundImage: 'linear-gradient(rgba(185,28,28,0.04) 1px,transparent 1px),linear-gradient(90deg,rgba(185,28,28,0.04) 1px,transparent 1px)',
            ...
            <svg className="absolute inset-0 w-full h-full pointer-events-none z-[1]">
              ...
              <line
                ...
                stroke="#B91C1C" strokeWidth="1.5" strokeDasharray="6 4" opacity="0.5"
              >
            ...
            {/* Hospital marker */}
            <div className="absolute z-[3]" style={{ left: '50%', top: '50%', transform: 'translate(-50%,-50%)' }}>
              <div className="w-9 h-9 bg-white border-[2.5px] border-[#B91C1C] rounded-full flex items-center justify-center text-base shadow-[0_4px_16px_rgba(185,28,28,0.25)]">🏥</div>
              <div className="absolute bottom-[-22px] left-1/2 -translate-x-1/2 text-[9px] font-bold text-[#B91C1C] whitespace-nowrap bg-white px-[5px] py-[2px] rounded-[4px] shadow-[0_2px_8px_rgba(0,0,0,0.1)]">Apollo Hospital</div>
            </div>
            ...
            {mapDots.map((dot, i) => (
              ...
              >
                ...
                />
                {hoveredDot === i && (
                  <div className="absolute bg-white rounded-[12px] px-[14px] py-[10px] shadow-[0_8px_32px_rgba(0,0,0,0.15)] text-[12px] pointer-events-none z-10 whitespace-nowrap"
                    style={{ transform: 'translate(-50%,-130%)', left: 0, top: 0 }}>
                    <div className="font-bold text-[#111]">{dot.name}</div>
                    <div className="text-[11px] text-[#B91C1C] font-semibold mt-[2px]">🩸 {dot.blood} · {dot.active ? '✓ Available' : '✗ Unavailable'}</div>
                    <div className="absolute bottom-[-6px] left-1/2 -translate-x-1/2 w-3 h-3 bg-white" style={{ clipPath: 'polygon(0 0,100% 0,50% 100%)' }} />
                  </div>
                )}
              </div>
            ))}
            ...
            <div className="map-legend-ov absolute bg-white rounded-[10px] shadow-[0_4px_20px_rgba(0,0,0,0.1)] text-[clamp(11px,1.2vw,13px)] bottom-[clamp(12px,2vw,24px)] right-[clamp(12px,2vw,24px)] px-[clamp(12px,1.8vw,20px)] py-[clamp(10px,1.5vw,16px)]">
              <div className="flex items-center gap-2 mb-2 text-[#555]"><div className="w-[10px] h-[10px] rounded-full bg-[#B91C1C] flex-shrink-0" /> Available donor</div>
              <div className="flex items-center gap-2 mb-2 text-[#555]"><div className="w-[10px] h-[10px] rounded-full bg-[#d1d5db] flex-shrink-0" /> Unavailable</div>
              <div className="flex items-center gap-2 text-[#555]"><span className="text-[12px]">🏥</span> Hospital</div>
            </div>
            <div className="map-req-ov absolute bg-white rounded-[10px] shadow-[0_4px_20px_rgba(0,0,0,0.1)] text-[clamp(11px,1.3vw,14px)] bottom-[clamp(12px,2vw,24px)] left-[clamp(12px,2vw,24px)] px-[clamp(12px,1.8vw,18px)] py-[clamp(10px,1.5vw,14px)] max-w-[clamp(160px,20vw,220px)]">
              <div className="font-bold text-[#111] mb-1 text-[clamp(12px,1.4vw,14px)]">🚨 Active Request</div>
              <div className="text-[clamp(10px,1.1vw,12px)] text-[#666]">Apollo Hospital · O− Blood</div>
              <div className="inline-block bg-[#fef2f2] text-[#B91C1C] text-[clamp(9px,1vw,11px)] font-bold px-2 py-[3px] rounded-full mt-[6px]">
                Critical · {mapDots.filter(d => d.active)[activeDotIndex % mapDots.filter(d => d.active).length]?.name} responding
              </div>
            </div>
          </div>
        </div>
      ...
      >
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at center,rgba(185,28,28,0.05) 0%,transparent 70%)' }} />

        <h2 className={`text-[clamp(28px,6vw,72px)] font-black tracking-tight leading-[1.05] mb-5 relative reveal ${isVisible('cta') ? 'visible' : ''}`}>
          Be the reason<br />
          <span className="gradient-text">someone survives.</span>
        </h2>
        <p className={`text-[clamp(15px,1.8vw,18px)] text-[#666] max-w-[480px] mx-auto mb-12 leading-[1.7] relative reveal ${isVisible('cta') ? 'visible' : ''}`} style={{ transitionDelay: '100ms' }}>
          Join thousands of donors and hospitals already using RedThread to save lives every day.
        </p>
        <div className={`cta-btns-wrap flex gap-3 justify-center flex-wrap relative reveal ${isVisible('cta') ? 'visible' : ''}`} style={{ transitionDelay: '200ms' }}>
          <button
        ...
        <div className={`flex items-center justify-center gap-[clamp(16px,3vw,32px)] mt-[clamp(24px,4vh,48px)] relative flex-wrap reveal ${isVisible('cta') ? 'visible' : ''}`} style={{ transitionDelay: '300ms' }}>
          {['✅ Free to join', '🔒 Secure & private', '⚡ Real-time matching', '🌍 Available 24/7'].map((t, i) => (
            <div key={i} className="flex items-center gap-[6px] text-[clamp(12px,1.4vw,14px)] text-[#888] font-medium">{t}</div>
          ))}
        </div>
      </div>
      ...
      <footer className="bg-[#111] text-white py-[clamp(40px,6vh,60px)] px-[clamp(16px,4vw,64px)] pb-[clamp(24px,4vh,40px)]">
        <div className="flex justify-between mb-[clamp(32px,5vh,48px)] gap-8 flex-wrap">
          ...
          <div className="flex gap-[clamp(32px,5vw,60px)] flex-wrap">
            <div>
              <div className="text-[clamp(10px,1.1vw,12px)] font-bold text-[#555] tracking-[2px] uppercase mb-4">Platform</div>
              {[['Become a Donor', '/register'], ['Register Hospital', '/register'], ['Login', '/login']].map(([label, path], i) => (
                <div key={i} className="text-[clamp(12px,1.3vw,14px)] text-[#666] cursor-pointer transition-colors duration-200 hover:text-[#ef4444] mb-[10px]" onClick={() => navigate(path)}>{label}</div>
              ))}
            </div>
            <div>
              <div className="text-[clamp(10px,1.1vw,12px)] font-bold text-[#555] tracking-[2px] uppercase mb-4">Features</div>
              {['Real-time Matching', 'Emergency Alerts', 'Donor Dashboard'].map((l, i) => (
                <div key={i} className="text-[clamp(12px,1.3vw,14px)] text-[#666] cursor-pointer transition-colors duration-200 hover:text-[#ef4444] mb-[10px]">{l}</div>
              ))}
            </div>
          </div>
        </div>
